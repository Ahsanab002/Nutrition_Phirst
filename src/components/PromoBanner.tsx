		...
		<section className="relative w-full">
			...
			<div className="absolute inset-0 flex items-center">
				<div className="container mx-auto px-4 lg:px-8">
					<div className="max-w-xl bg-black/10 backdrop-blur-[2px] rounded-xl p-6 md:p-8 md:pb-12 lg:pb-16 shadow-product translate-x-[-8px] md:translate-x-[-16px] lg:translate-x-[-24px]">
						...
						<div className="flex flex-wrap gap-3">
							...
							<a href="/13.jpg" target="_blank" rel="noreferrer">
